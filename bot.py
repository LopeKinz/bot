...
async def on_ready():
    ...
    await bot.change_presence(activity=discord.Activity(type=discord.ActivityType.watching, name="Follow @Pinkyhax on Instagram! | Type .h for Help! Hail Legend Pinkyhax"))
...
async def h(ctx):
    ...
    if ctx.author.guild_permissions.administrator or valid_user:
        ...
        em = discord.Embed(title="Pinkys Support Bot Help", description="", color=0x00a8ff)
        ...
        em.set_footer(text="Pinkyhax DEV")
...
async def new(ctx, *, args = None):
    ...
    created_em = discord.Embed(title="Pinkys Support Bot", description="Your ticket has been created at {}".format(ticket_channel.mention), color=0x00a8ff)
    
    await ctx.send.dir(embed=created_em)
...
async def close(ctx):
    ...
    if ctx.channel.id in data["ticket-channel-ids"]:
        ...
        try:
            ...
            em = discord.Embed(title="Pinkys Support Bot", description="Are you sure you want to close this ticket? Reply with `close` if you are sure.", color=0x00a8ff)
            ...
            em = discord.Embed(title="Pinkys Support Bot", description="You have run out of time to close this ticket. Please run the command again.", color=0x00a8ff)
            await ctx.send(embed=em)
            await ctx.message.delete()
    ...
    if valid_user or ctx.author.guild_permissions.administrator:
        ...
        if role_id not in data["valid-roles"]:
            ...
            try:
                ...
                em = discord.Embed(title="Pinkys Support Bot", description="You have successfully added `{}` to the list of roles with access to tickets.".format(role.name), color=0x00a8ff)

                await ctx.send(embed=em)

            except:
                em = discord.Embed(title="Pinkys Support Bot", description="That isn't a valid role ID. Please try again with a valid role ID.")
                await ctx.send(embed=em)
        
        else:
            em = discord.Embed(title="Pinkys Support Bot", description="That role already has access to tickets!", color=0x00a8ff)
            await ctx.send(embed=em)
    
    else:
        em = discord.Embed(title="Pinkys Support Bot", description="Sorry, you don't have permission to run that command.", color=0x00a8ff)
        await ctx.send(embed=em)
        await ctx.message.delete()
    ...
    if valid_user or ctx.author.guild_permissions.administrator:
        ...
        try:
            ...
            if role_id in valid_roles:
                ...
                em = discord.Embed(title="Pinkys Support Bot", description="You have successfully removed `{}` from the list of roles with access to tickets.".format(role.name), color=0x00a8ff)

                await ctx.send(embed=em)
            
            else:
                
                em = discord.Embed(title="Pinkys Support Bot", description="That role already doesn't have access to tickets!", color=0x00a8ff)
                await ctx.send(embed=em)
    ...
    if valid_user or ctx.author.guild_permissions.administrator:
        ...
        if role_id not in data["pinged-roles"]:
            ...
            try:
                ...
                em = discord.Embed(title="Pinkys Support Bot", description="You have successfully added `{}` to the list of roles that get pinged when new tickets are created!".format(role.name), color=0x00a8ff)
            ...
            em = discord.Embed(title="Pinkys Support Bot", description="That role already receives pings when tickets are created.", color=0x00a8ff)
            await ctx.send(embed=em)
    ...
    if valid_user or ctx.author.guild_permissions.administrator:
        ...
        try:
            ...
            if role_id in pinged_roles:
                ...
                em = discord.Embed(title="Pinkys Support Bot", description="You have successfully removed `{}` from the list of roles that get pinged when new tickets are created.".format(role.name), color=0x00a8ff)
                await ctx.send(embed=em)
            
            else:
                em = discord.Embed(title="Pinkys Support Bot", description="That role already isn't getting pinged when new tickets are created!", color=0x00a8ff)
                await ctx.send(embed=em)
...
async def addadminrole(ctx, role_id=None):
    ...
    try:
        ...
        em = discord.Embed(title="Pinkys Support Bot", description="You have successfully added `{}` to the list of roles that can run admin-level commands!".format(role.name), color=0x00a8ff)
        await ctx.send(embed=em)
...
async def deladminrole(ctx, role_id=None):
    try:
        ...
        if role_id in admin_roles:
            ...
            em = discord.Embed(title="Pinkys Support Bot", description="That role isn't getting pinged when new tickets are created!", color=0x00a8ff)
            await ctx.send(embed=em)
...
bot.run("ODA0NzQ4NjgyNTczNTEyNzM1.YBQ2nQ.8JVlffMHHd-O6hzWHsUJwU9Oakc")